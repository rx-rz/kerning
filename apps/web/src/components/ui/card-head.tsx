...
function CardHead({
	...
	return (
		...
		>
			...
			<div className="mono-label text-center">{title}</div>
...
function GlassCardHead(props: Omit<CardHeadProps, "variant">) {
	return <CardHead variant="glass" {...props} />;
}

function SolidCardHead(props: Omit<CardHeadProps, "variant">) {
	return <CardHead variant="solid" {...props} />;
}

function BlackCardHead(props: Omit<CardHeadProps, "variant">) {
	return <CardHead variant="black" {...props} />;
}

export { CardHead, GlassCardHead, SolidCardHead, BlackCardHead };
