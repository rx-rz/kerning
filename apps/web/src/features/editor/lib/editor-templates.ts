...
export function resolveTemplateFonts(
	...
	const mixedRoles = ["primary", "sec1", "sec2"] as const;
	const roleByNodeId = new Map(
		textNodes.map((node, index) => [
			node.id,
			mixedRoles[index % mixedRoles.length],
		]),
	);
	...
	return {
		...
		nodes: card.nodes.map((node) =>
			node.type === "text"
				? {
						...node,
						fontType: resolveTemplateFontType(
							roleByNodeId.get(node.id) ?? node.fontType,
							available,
						),
					}
				: node,
...
const ALBUM_GUIDES: VisualGuide[] = [
	...
	},
	{
		name: "Dream Pop",
		title: "soft weather",
		subtitle: "01 bloom · 02 closer · 03 violet",
		background: "#D9D2E8",
		ink: "#4C3D58",
		accent: "#F2B9A8",
		image: 11,
	...
	},
	{
		...
		title: "静かな構造",
		subtitle: "QUIET STRUCTURES · TOKYO",
		background: "#EEECE4",
		ink: "#20201E",
		accent: "#B83A2F",
		image: 4,
	...
	{
		name: "Y2K Electronica",
		title: "CHROME//HEART",
		subtitle: "NOVA SYSTEM · 2001",
		background: "#10121B",
		ink: "#EAFBFF",
		accent: "#72E6FF",
		image: 7,
	},
	{
		...
		subtitle: "MOTEL RADIO · live from the pines",
		background: "#D8C7A7",
		ink: "#3B2F25",
		accent: "#8A4B35",
		image: 10,
	},
	{
		name: "Jazz Classic",
		title: "BLUE\nHOUR",
		subtitle: "THEO BLUE QUARTET · SESSIONS 01–08",
		background: "#172238",
		ink: "#F0E4C2",
		accent: "#C7A748",
		image: 20,
	},
	{
		name: "Afrofuturism",
		title: "LAGOS / ORBIT",
		subtitle: "AYO KORA · TRANSMISSION ONE",
		background: "#163A55",
		ink: "#FFF0BE",
		accent: "#F36A2D",
		image: 15,
	},
	{
		name: "Bauhaus",
		title: "FORM / 20",
		subtitle: "STUDY IN PRIMARY RHYTHM",
		background: "#F1EBDD",
		ink: "#131313",
		accent: "#E12B24",
		image: null,
	},
	{
		...
		title: "THE DISTANT VALLEY",
		subtitle: "ORIGINAL SCORE · ELIAS MOREAU",
		background: "#D8DFE1",
		ink: "#1C2529",
		accent: "#7C8C91",
		image: 9,
	},
	{
		name: "Punk Zine",
		title: "NO\nSAINTS",
		subtitle: "SIDE A · LOUDER THAN PROOF",
		background: "#E7E2D8",
		ink: "#101010",
		accent: "#D2231D",
		image: 12,
	...
	},
	{
		...
		title: "MIND FLOWER",
		subtitle: "PRISM CHILD · A STEREO DREAM",
		background: "#F04D9C",
		ink: "#24134A",
		accent: "#FFE43B",
		image: 5,
	...
	},
	{
		name: "Ambient",
		title: "almost still",
		subtitle: "FIELD RECORDINGS · 06:14:09",
		background: "#E6ECEE",
		ink: "#657278",
		accent: "#B8CBD3",
		image: 11,
	...
	{
		name: "Contemporary Creative Agency",
		title: "NEW / COMMON",
		subtitle: "AN AUDIO IDENTITY BY FIELD OFFICE",
		background: "#F3EFE6",
		ink: "#171717",
		accent: "#4B47FF",
		image: 14,
...
const MOVIE_GUIDES: VisualGuide[] = [
	{
		name: "A24 Drama",
		title: "A quiet measure",
		subtitle: "A film by Mara Sen",
		background: "#D8CDBD",
		ink: "#25211D",
		accent: "#8D7762",
		image: 13,
	},
	{
		...
		title: "ORBITAL",
		subtitle: "THE FUTURE HAS ONE SURVIVOR",
		background: "#071A31",
		ink: "#E6FAFF",
		accent: "#20D8F5",
		image: 7,
	...
	{
		name: "Indie Coming-of-Age",
		title: "summer, maybe",
		subtitle: "WE THOUGHT IT WOULD LAST",
		background: "#C8D1B7",
		ink: "#33402E",
		accent: "#E78045",
		image: 10,
	},
	{
		name: "Neo-Noir",
		title: "BLACK TIDE",
		subtitle: "EVERY SHADOW HAS A WITNESS",
		background: "#08090B",
		ink: "#F0E8DD",
		accent: "#C41E2A",
		image: 24,
	},
	{
		name: "Documentary",
		title: "COMMON GROUND",
		subtitle: "TEN VOICES. ONE STREET. A DOCUMENTARY.",
		background: "#E5E2DA",
		ink: "#242522",
		accent: "#66756E",
		image: 8,
	},
	{
		...
		subtitle: "BEYOND THE LAST KINGDOM",
		background: "#173C35",
		ink: "#F0D9A2",
		accent: "#B58A3B",
		image: 9,
	...
	},
	{
		name: "70s Cinema",
		title: "MATINÉE '74",
		subtitle: "ONE SUMMER CHANGED THE PICTURE",
		background: "#D9A62E",
		ink: "#3B2519",
		accent: "#C84B2F",
		image: 5,
	...
	},
	{
		...
		subtitle: "LOVE ARRIVES WITHOUT A MAP",
		background: "#EAD7D3",
		ink: "#55353A",
		accent: "#B66C76",
		image: 25,
	...
	{
		name: "Experimental Festival Poster",
		title: "FRAME / BREAK",
		subtitle: "OFFICIAL SELECTION · BERLIN 2026",
		background: "#E9E5DC",
		ink: "#161616",
		accent: "#FF4B27",
		image: 17,
	},
	{
		name: "Biopic",
		title: "VERONIQUE",
		subtitle: "THE LIFE BEHIND THE LIGHT",
		background: "#A36E50",
		ink: "#F1E4D1",
		accent: "#C99E6D",
		image: 14,
	},
	{
		name: "Cyberpunk",
		title: "NULL//CITY",
		subtitle: "MEMORY IS THE NEW CONTRABAND",
		background: "#090B16",
		ink: "#D7FAFF",
		accent: "#FF3CA6",
		image: 17,
	},
	{
		name: "Animated Film",
		title: "Milo & the Moon",
		subtitle: "THE SKY IS CLOSER THAN YOU THINK",
		background: "#76C9E8",
		ink: "#23355C",
		accent: "#FFD44C",
		image: 11,
	},
	{
		name: "Fashion Film",
		title: "Élan No. 4",
		subtitle: "A FILM FOR MAISON ÉLAN",
		background: "#EAE2D6",
		ink: "#29231F",
		accent: "#9B7B52",
		image: 16,
	},
	{
		...
		subtitle: "A FILM BY NORA FIELD · 94 MIN",
		background: "#F0F0EC",
		ink: "#111111",
		accent: "#D42C23",
		image: 0,
...
const BUSINESS_GUIDES = [
	...
	[
		"Creative Agency",
		"AMARA",
		"Field Office · Creative direction",
		"#FF5A3D",
		"#241A42",
		"#FFF45C",
	],
	...
	[
		"Monospace Identity",
		"> EVAN_LIN",
		"design.engineering@mono.studio",
		"#F4F4F0",
		"#111111",
		"#5A6A61",
	],
...
function albumGuideNodes(guide: VisualGuide, index: number): EditorNode[] {
	...
	if (guide.image !== null) {
		const [x, y, width, height] =
			ALBUM_IMAGE_BOXES[index % ALBUM_IMAGE_BOXES.length] ??
			ALBUM_IMAGE_BOXES[0];
		nodes.push(
	...
	if (index === 15) {
		nodes.push(
			text("album-15-first", "T", 18, 34, 250, 270, 254, guide.ink, {
				letterSpacing: -18,
				lineHeight: 0.75,
			}),
			text("album-15-last", "Y", 228, 164, 250, 270, 254, guide.accent, {
				letterSpacing: -18,
				lineHeight: 0.75,
			}),
		);
	...
	const titleSizes = [
		70, 54, 82, 66, 43, 58, 45, 68, 52, 54, 44, 80, 30, 56, 54, 48, 24, 64, 50,
		62,
	];
	const titleY = [
		34, 38, 20, 34, 30, 344, 34, 28, 350, 338, 390, 24, 32, 354, 34, 374, 34,
		330, 38, 340,
	];
				...
				letterSpacing:
					index === 5 || index === 12 || index === 17
						...
						: index === 2
							...
							: -2,
				textCasing:
					index === 1 || index === 6 || index === 16 ? "lowercase" : "none",
			},
		),
		text(
			`album-${index}-meta`,
...
function movieGuideNodes(guide: VisualGuide, index: number): EditorNode[] {
	const [x, y, width, height] =
		POSTER_IMAGE_BOXES[index % POSTER_IMAGE_BOXES.length] ??
		POSTER_IMAGE_BOXES[0];
	const imageNode = guidedImage(
		`movie-${index}-image`,
		guide.image ?? 0,
		x,
		y,
	...
	const titleSize =
		[
			34, 58, 14, 40, 34, 54, 26, 44, 22, 46, 34, 48, 38, 60, 56, 42, 42, 40,
			18, 48,
		][index] ?? 42;
	const titleY =
		[
			502, 522, 302, 470, 520, 58, 504, 508, 520, 474, 82, 484, 506, 510, 416,
			488, 500, 500, 542, 500,
		][index] ?? 500;
	...
	return [
		...
		text(
			`movie-${index}-cast`,
			"AMARA OKOYE   MIKA CHEN   ELI BROOKS",
			28,
			24,
			304,
			14,
			7,
			guide.ink,
			{ letterSpacing: 1, textAlign: index === 19 ? "left" : "center" },
		),
		text(
			`movie-${index}-title`,
			guide.title,
			...
			guide.ink,
			{
				...
				textAlign:
					index === 19
						? "left"
						: index === 0 || index === 12 || index === 15
							? "center"
							: "left",
				textCasing: [0, 4, 8, 12, 17, 18].includes(index)
					? "none"
					: "uppercase",
			},
		),
		...
		text(
			`movie-${index}-credit`,
			"A FIELD OFFICE PICTURE · 2026 · 104 MIN",
			28,
			620,
			304,
			10,
...
function businessGuideNodes(
	...
	const big =
		[
			26, 44, 78, 88, 30, 22, 30, 34, 46, 40, 28, 62, 84, 24, 42, 94, 18, 48,
			58, 30,
		][index] ?? 40;
	const nodes: EditorNode[] = [
		text(
			...
			index % 4 === 2 ? 12 : 28,
			index % 5 === 3 ? 34 : 82,
			hasImage ? 326 : index % 4 === 2 ? 536 : 504,
			112,
			big,
			ink,
			{
		...
		text(`business-${index}-meta`, role, 28, 262, 300, 20, 10, ink, {
			letterSpacing: 1,
		}),
		text(
			...
			9,
			ink,
			{ lineHeight: 1.4, textAlign: "right", letterSpacing: 0 },
		),
		text(
			`business-${index}-side`,
			`0${index + 1} / 20`,
...
function specimenNodes(
	...
	if (index % 5 === 0) {
		return [
			text(`specimen-${index}-cat`, catalog, 24, 22, 352, 14, 7, ink, {
				letterSpacing: 2,
			}),
			text(`specimen-${index}-title`, family, 24, 44, 352, 34, 24, accent, {
				fontWeight: 500,
				letterSpacing: -1,
			}),
			text(
				`specimen-${index}-first`,
				"AABBCCDDEEFFGG\nHHIIJJKKLLMM\nNNOOPPQQRRSSTT\nUUVVWWXXYYZZ\nabcdefghijklmn\nopqrstuvwxyz\n1234567890",
				20 + series * 2,
				90,
				360 - series * 4,
				...
				38 + series * 2,
				ink,
				{ fontWeight: 500, lineHeight: 0.9, letterSpacing: -2 - series },
			),
			shape(
				`specimen-${index}-rule`,
				"line",
			...
			text(
				`specimen-${index}-meta`,
				"DISPLAY CUT\nHigh contrast forms for expressive editorial settings.",
				24,
				420,
				108,
				54,
			...
			text(
				`specimen-${index}-credit`,
				"TEXT CUT\nBuilt for rhythm, detail, and long-form reading.",
				146,
				420,
				108,
				54,
	...
	if (index % 5 === 1) {
		return [
			...
			text(
				...
				58 + series * 3,
				ink,
				{ fontWeight: 500, lineHeight: 0.9, letterSpacing: -4 },
			),
			text(
				`specimen-${index}-year`,
				"created\n1970–77",
			...
			text(
				...
				80 - series * 4,
				accent,
				{ fontWeight: 800, lineHeight: 0.72, letterSpacing: -6 + series },
			),
			text("specimen-alpha", alphabet, 26, 370, 164, 66, 11, ink, {
				lineHeight: 1.25,
				letterSpacing: 0,
			}),
			text(
				`specimen-${index}-credit`,
				"History Sample:\nA family built from precise geometry, optical correction, and memorable proportions.",
				210,
				370,
				166,
				66,
	...
	if (index % 5 === 2) {
		return [
			text(
				`specimen-${index}-cat`,
				`SAMPLE OF ${family.toUpperCase()} FAMILIES`,
				24,
				24,
				352,
				14,
			...
			text(
				...
				278 - series * 8,
				accent,
				{ fontWeight: 400, lineHeight: 0.75, letterSpacing: -18 },
			),
			text(
				"specimen-alpha",
				"REGULAR 16 PT\nABCDEFGHIJKLMNO\nPQRSTUVWXYZ\nabcdefghijklmnop\nqrstuvwxyz",
			...
			text(
				...
				9,
				ink,
				{ fontWeight: 700, lineHeight: 1.25, letterSpacing: 0 },
			),
			text(
				`specimen-${index}-credit`,
				"REGULAR\nCONDENSED\nBOLD",
			...
			text(`specimen-${index}-side`, "05", 350, 462, 24, 14, 8, ink, {
				textAlign: "right",
			}),
		];
	}
	...
	if (index % 5 === 3) {
		return [
			text(
				...
				24,
				ink,
				{ fontWeight: 700, letterSpacing: -1, textAlign: "justify" },
			),
			text(
				`specimen-${index}-title`,
				"“The power to make language visible; to give every thought a form, a rhythm, and a voice.”",
				22 + series * 2,
				112 - series * 6,
				356 - series * 4,
				258,
			...
			text(
				`specimen-${index}-meta`,
				"A typographic specimen about freedom, clarity, and the expressive life of letters. Set across display and reading sizes.",
				22,
				448,
				170,
				34,
			...
			text(
				`specimen-${index}-credit`,
				"EDITOR IN CHIEF · TYPE DIRECTOR · DESIGN OFFICE\nPrinted in Lagos · Edition 01",
				208,
				448,
				170,
				34,
				6,
				ink,
				{ lineHeight: 1.25, letterSpacing: 0, textAlign: "right" },
			),
		];
	}

	return [
		text(`specimen-${index}-cat`, catalog, 24, 22, 352, 14, 8, ink, {
			letterSpacing: 2,
		}),
		text(
			`specimen-${index}-title`,
			...
			84 - series * 3,
			accent,
			{ fontWeight: 800, lineHeight: 0.78, letterSpacing: -6 + series },
		),
		text(
			`specimen-${index}-first`,
			glyph,
			...
			166 - series * 6,
			ink,
			{ fontWeight: 500, lineHeight: 0.8, letterSpacing: -10 },
		),
		text("specimen-alpha", alphabet, 218, 190, 158, 76, 12, ink, {
			lineHeight: 1.3,
			letterSpacing: 0,
		}),
		text(
		...
		text(`specimen-${index}-year`, "0123456789", 24, 384, 352, 44, 34, ink, {
			fontWeight: 700,
			letterSpacing: 2,
		}),
		shape(
		...
		text(
			`specimen-${index}-credit`,
			"DESIGNED FOR HEADLINES, IDENTITIES, CULTURE, AND THE BEAUTIFUL MESS OF LANGUAGE.",
			24,
			456,
			352,
			24,
...
function makeGuidedTemplate(
	...
	return {
		...
		card: {
			...
			settings: solidTemplateSettings(
				aspectRatio,
				guide.background,
				[0, 2, 4, 6, 9, 11, 18, 19].includes(index),
			),
			nodes: album
				? albumGuideNodes(guide, index)
				: movieGuideNodes(guide, index),
		},
	};
}
	...
	return {
		...
		card: {
			...
			settings: solidTemplateSettings(
				"business-card",
				guide[3],
				[0, 1, 3, 4, 6, 12, 16, 17, 19].includes(index),
			),
...
export const EDITOR_TEMPLATES: EditorTemplate[] = [
	...ALBUM_GUIDES.map((guide, index) =>
		makeGuidedTemplate(guide, index, "Album covers"),
	),
